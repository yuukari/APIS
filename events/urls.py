...
urlpatterns = [
	...
	url(r'^manage/visual/horizontal/$', views.visualHorizontal, name='visual'),
	url(r'^manage/glance/$', views.glance, name='glance'),
	url(r'^manage/slot/new/$', views.slotMod, name='new-slot'),
	url(r'^manage/slot/(?P<slot_id>[\w-]+)/edit/$', views.slotMod, name='edit-slot'),
	url(r'^manage/slot/(?P<slot_id>[\w-]+)/$', views.manageSlot, name='slot'),
	url(r'^controls/v1/helper/close/$', views.ControlsV1HelperClose, name='helper-close'),
